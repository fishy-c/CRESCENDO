...
public class EFarAMPTHREE extends SequentialCommandGroup{
    ...
    private final PathPlannerPath AmpPathForward2 = PathPlannerPath.fromChoreoTrajectory("ampcloseforward");
    private final PathPlannerPath AmpPathBackward2 = PathPlannerPath.fromChoreoTrajectory("ampclosebackward");

    public EFarAMPTHREE(Swerve swerve, Superstructure superstructure){
